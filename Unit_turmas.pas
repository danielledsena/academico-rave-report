...
begin
   ...
   //Retorna o valor formatado de acordo com o destino
   if destino = 'T' then
      ...
      result := valor_formatado
        ...
        begin
            //Varre a string para substituir a vúrgula por ponto
...
begin
   ...
   begin
      ...
      sql := ' SELECT TURMAS.COD_TURMA, TURMAS.VALOR_AULA, ' +
             ...
             ' ISNTRUTORES.NOME AS INSTRUTOR, INSTRUTORES.COD_INSTRUTOR ' +
             ' FROM TURMAS ' +
             ' INNER JOIN CURSOS ' +
